...
import com.nowcoder.community.dao.elsaticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testSearchRepository(){
        SearchQuery searchQuery=new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.multiMatchQuery("互联网寒冬","titile","content"))
    ...
    @Test
    public void testSearchByTemplates(){
        SearchQuery searchQuery=new NativeSearchQueryBuilder()
